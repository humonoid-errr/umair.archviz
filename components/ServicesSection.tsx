...
const services: Service[] = [
  {
    ...
    description:
      "Our team crafts meticulously detailed designs for both indoor and outdoor spaces, ensuring functionality, aesthetics, and harmony.",
    icon: <InteriorDesignIcon className="w-full h-full" />,
  },
  {
    title: "3D Modelling",
    description:
      "We transform concepts into lifelike 3D models, providing you with a realistic visualization of your project before construction begins.",
    icon: <ModellingIcon className="w-full h-full" />,
  },
  {
    title: "Commercial Design",
    description:
      "From retail stores to office buildings, we create innovative designs that enhance brand identity and customer experience.",
    icon: <CommercialIcon className="w-full h-full" />,
  },
  {
    title: "Space Planning",
    description:
      "Our expertise in space planning maximizes efficiency and flow within your space, optimizing layouts for both residential and commercial projects.",
    icon: <SpacePlanningIcon className="w-full h-full" />,
  },
  {
    title: "Rendering Service",
    description:
      "Enhancing 3D models with detailed design elements, materials, and lighting scenarios for vivid visualizations of your architectural projects.",
    icon: <RenderingIcon className="w-full h-full" />,
  },
  {
    title: "Product Visualization",
    description:
      "We create stunning renderings and animations that showcase product designs with precision and realism, elevating your marketing.",
...
const ServicesSection: React.FC = () => {
  return (
    <section
      id="services"
      className="min-h-screen w-full flex flex-col bg-white text-gray-800 px-8 md:px-24 pt-24 md:pt-32 pb-8"
    >
